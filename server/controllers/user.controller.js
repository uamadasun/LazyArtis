...
module.exports.register = (req, res) => {
    ...
    .then(user => {
        // let potentialUser = User.findOne({email:req.body.email});
        // if(potentialUser === null) {
        //     res.status(400).json({ msg: "This email is already in the system. Try again or login." })
        //     res.cookie()
        //     return;
        // }
        // } else {
                        ...
                        .then(passwordIsValid => {
                            if (passwordIsValid === true) {
                                ...
                                res
                                    .cookie(
                                        "usertoken",
                                        jwt.sign({ _id: user._id }, process.env.SECURE_USER_KEY),
                                        {
                                            httpOnly: true,
                                        }
                                    )
